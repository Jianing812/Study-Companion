          ...
          <div className="space-y-8">
            <div className="rounded-3xl bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                ...
                in one sentence. This reduces passive rereading and helps with
                active recall.
              </p>
              ...
              <div className="mt-6 rounded-2xl bg-amber-100 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-700">
                  Define the main idea of your chapter in one sentence, then
                  identify one part that still feels confusing.
                </p>
              </div>
            </div>
